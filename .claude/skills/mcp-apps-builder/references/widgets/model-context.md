...
| Situation                                                | Use                                      |
| -------------------------------------------------------- | ---------------------------------------- |
| Annotate what the user is _seeing_ right now             | `<ModelContext>` or `modelContext.set()` |
...
- `ModelContext` = declarative description of what the user _sees_. Set it and forget it.
  ...
  return (
    <McpUseProvider autoSize>
      ...
      <ModelContext content="User is viewing the analytics dashboard">
        ...
        {hovered && <ModelContext content={`Hovering over chart: ${hovered}`} />}
